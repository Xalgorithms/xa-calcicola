...
public class Constants {
    public static final String ARG_SITE = "org.lichen.garni.intents.ARGS.SITE";
    public static final String ARG_ACCOUNT_ID = "org.lichen.garni.intents.ARGS.ACCOUNT_ID";
